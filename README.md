...
It has the functionality of sorting by categories, if you click on a specific category search engine locks itself and every letter entered in the search field will display only movies/series in that category.<br>
